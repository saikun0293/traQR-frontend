<template>
  <div class="font-body bg-myBlack text-white">
    ...
    <div class="text-center my-2 font-bold text-myRed">
    ...
    <div class="grid grid-cols-3 place-items-center py-5">
      <router-link
        :to="`/student/${this.$route.params.id}/`"
        :class="[
          blueLine === 0 ? 'border-b-4 border-myRed' : '',
      ...
      <router-link
        :class="[
          blueLine === 1 ? 'border-b-4 border-myRed' : '',
          'w-full text-center pb-3',
        ]"
        :to="`/student/${this.$route.params.id}/qrcode`"
        >QR Code</router-link
      >
      <router-link
        :class="[
          blueLine === 2 ? 'border-b-4 border-myRed' : '',
          'w-full text-center pb-3',
        ]"
        :to="`/student/${this.$route.params.id}/chatroom`"
